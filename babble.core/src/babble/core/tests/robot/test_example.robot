...
#
#  $ bin/test -s babble.core -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src babble.core.testing.BABBLE_CORE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/babble/core/tests/robot/test_example.robot
#
